...
function About() {
  return (
      ...
      <p className= 'mb-4 text-slate-800'> This is a MERN (MongoDB, Express, React, Node.js) stack application with
      ...
      using JSON Web Tokens (JWT).</p>
        <p className= 'mb-4 text-slate-800'> This application is intended as a starting point for building full-stack
